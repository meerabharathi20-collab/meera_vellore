      ...
      <div class="section-container">
        <div class="reveal visible">
          ...
          <div class="places-preview-grid" style="margin-top: 2rem;">
            <!-- Card 1: Vellore Yathra Tours and Travels -->
            <div class="preview-card">
              <a href="https://www.google.com/maps/search/?api=1&query=Vellore+Yathra+Tours+and+Travels+Gandhi+Nagar+Vellore" target="_blank" title="View on Google Maps">
                <img src="yathra-travels.png" alt="Vellore Yathra Tours and Travels">
              </a>
              <div class="preview-card-body" style="display: flex; flex-direction: column; gap: 8px;">
                <h3 style="margin-bottom: 0.2rem; color: var(--primary);">Vellore Yathra Tours and Travels</h3>
                <p style="margin: 0; font-size: 0.88rem; color: var(--gray-700); line-height: 1.5;">
                  <strong>📍 Address:</strong> 30/6, 1st East Main Rd, Suthanthira Ponvizha Nagar, Gandhi Nagar, Vellore - 632006
                </p>
                <p style="margin: 0; font-size: 0.88rem; color: var(--gray-700); line-height: 1.5;">
            ...
            <!-- Card 2: Holidays World Tours & Travels -->
            <div class="preview-card">
              <a href="https://www.google.com/maps/search/?api=1&query=Holidays+World+Tours+and+Travels+Katpadi+Vellore" target="_blank" title="View on Google Maps">
                <img src="holidays-world.png" alt="Holidays World Tours & Travels">
              </a>
              <div class="preview-card-body" style="display: flex; flex-direction: column; gap: 8px;">
                <h3 style="margin-bottom: 0.2rem; color: var(--primary);">Holidays World Tours & Travels</h3>
                <p style="margin: 0; font-size: 0.88rem; color: var(--gray-700); line-height: 1.5;">
                  <strong>📍 Address:</strong> 108, Chittoor Road, Dharapadavedu (Near Panchayat Office), Katpadi, Vellore - 632007
                </p>
                <p style="margin: 0; font-size: 0.88rem; color: var(--gray-700); line-height: 1.5;">
                  <strong>⏰ Timing:</strong> Monday to Sunday: Open 24 hours
                </p>
            ...
            <!-- Card 3: Khan's Tours And Travels -->
            <div class="preview-card">
              <a href="https://www.google.com/maps/search/?api=1&query=Khans+Tours+And+Travels+Sripuram+Vellore" target="_blank" title="View on Google Maps">
                <img src="khans-travels.png" alt="Khan's Tours And Travels">
              </a>
              <div class="preview-card-body" style="display: flex; flex-direction: column; gap: 8px;">
                <h3 style="margin-bottom: 0.2rem; color: var(--primary);">Khan's Tours And Travels</h3>
                <p style="margin: 0; font-size: 0.88rem; color: var(--gray-700); line-height: 1.5;">
                  <strong>📍 Address:</strong> Sukkaiyavadhiyar St, Sripuram (Opposite KVB Bank, near CMC Hospital), Vellore - 632004
                </p>
                <p style="margin: 0; font-size: 0.88rem; color: var(--gray-700); line-height: 1.5;">
            ...
            <!-- Card 4: JSC Holidays -->
            <div class="preview-card">
              <a href="https://www.google.com/maps/search/?api=1&query=JSC+Holidays+Allapuram+Vellore" target="_blank" title="View on Google Maps">
                <img src="jsc-holidays.png" alt="JSC Holidays">
              </a>
              <div class="preview-card-body" style="display: flex; flex-direction: column; gap: 8px;">
                <h3 style="margin-bottom: 0.2rem; color: var(--primary);">JSC Holidays</h3>
                <p style="margin: 0; font-size: 0.88rem; color: var(--gray-700); line-height: 1.5;">
                  <strong>📍 Address:</strong> No 2, Anna Nagar Main Rd, Rajiv Gandhi Nagar, Allapuram, Vellore - 632001
                </p>
                <p style="margin: 0; font-size: 0.88rem; color: var(--gray-700); line-height: 1.5;">
            ...
            <!-- Card 5: Rashi Tours & Travels -->
            <div class="preview-card">
              <a href="https://www.google.com/maps/search/?api=1&query=Rashi+Tours+and+Travels+Saidapet+Vellore" target="_blank" title="View on Google Maps">
                <img src="rashi-travels.png" alt="Rashi Tours & Travels">
              </a>
              <div class="preview-card-body" style="display: flex; flex-direction: column; gap: 8px;">
                <h3 style="margin-bottom: 0.2rem; color: var(--primary);">Rashi Tours & Travels</h3>
                <p style="margin: 0; font-size: 0.88rem; color: var(--gray-700); line-height: 1.5;">
                  <strong>📍 Address:</strong> 11, Latif Basha St, Sripuram, Saidapet, Vellore - 632004
                </p>
                <p style="margin: 0; font-size: 0.88rem; color: var(--gray-700); line-height: 1.5;">
            ...
            <!-- Card 6: Sree Sravanam Tours & Travels -->
            <div class="preview-card">
              <a href="https://www.google.com/maps/search/?api=1&query=Sree+Sravanam+Tours+and+Travels+Long+Bazaar+Vellore" target="_blank" title="View on Google Maps">
                <img src="sravanam-travels.png" alt="Sree Sravanam Tours & Travels">
              </a>
              <div class="preview-card-body" style="display: flex; flex-direction: column; gap: 8px;">
                <h3 style="margin-bottom: 0.2rem; color: var(--primary);">Sree Sravanam Tours & Travels</h3>
                <p style="margin: 0; font-size: 0.88rem; color: var(--gray-700); line-height: 1.5;">
                  <strong>📍 Address:</strong> 33, Filter Bed Road, Long Bazaar, Vellore - 632001
                </p>
                <p style="margin: 0; font-size: 0.88rem; color: var(--gray-700); line-height: 1.5;">
