...
<h2>Tourist Places</h2>
      ...
      <div class="places-scroller">
        <div class="scroller-item"><a href="vellore-fort.php"><img src="vellorefort.png" alt="Vellore Fort"></a></div>
        <div class="scroller-item"><a href="govt-museum.php"><img src="govtmuseum.png" alt="Government Museum"></a></div>
        <div class="scroller-item"><a href="observatory.php"><img src="observatory.png" alt="Kavalur Observatory"></a></div>
        <div class="scroller-item"><a href="yelagiri.php"><img src="yelagiri-hills.png" alt="Yelagiri"></a></div>
        <div class="scroller-item"><a href="amrithi-forest.php"><img src="amirthi-forest.png" alt="Amirthi Forest"></a></div>
        <div class="scroller-item"><a href="jalagamparai-falls.php"><img src="jalgamparai-falls.png" alt="Jalagamparai Falls"></a></div>
      </div>
